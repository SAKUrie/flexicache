...
\textbf{WCET Analysis Integration.} The ultimate goal is integrating Flexicache with WCET analysis tools. Since our system has bounded execution paths (table lookups are O(n) with n $\leq$ 64, memcpy is O(size)), WCET bounds can be computed statically. This would enable formal verification of real-time guarantees.
